...
var disconnection = function (socketId) {
    
};

var chatMessageReceived = function (chatMsg) {
    
};

var gameAnswerReceived = function (answerMsg) {
    
};
/**
 * Event for customer connecting to the game
 */

var connection = function (socketId, socket) {
